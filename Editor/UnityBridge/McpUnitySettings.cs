...
namespace McpUnity.Unity
{
    ...
    public class McpUnitySettings
    {
        ...
        [Tooltip("Automatically start Node.js MCP Server in WebSocket mode when Unity Bridge starts")]
        public bool AutoStartMcpWebSocketServer = false;

        [Tooltip("Port for Node.js MCP Server WebSocket mode (default: 3000)")]
        public int McpWebSocketPort = 3000;
