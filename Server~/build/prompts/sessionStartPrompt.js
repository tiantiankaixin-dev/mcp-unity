 ...
 */
export function registerSessionStartPrompt(server) {
    server.prompt('unity_session_start', '⚠️ MANDATORY ⚠️ Read this FIRST at the start of EVERY conversation before using ANY Unity tools - Establishes required hierarchical workflow', {}, async () => ({
        messages: [
            {
                role: 'user',
                content: {
