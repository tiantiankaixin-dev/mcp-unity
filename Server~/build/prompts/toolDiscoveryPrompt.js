 ...
 */
export function registerToolDiscoveryPrompt(server) {
    server.prompt('unity_tool_discovery', 'REQUIRED: Complete guide for discovering and using Unity MCP tools through the MANDATORY hierarchical tool system - Read this for detailed workflow', {}, async () => ({
        messages: [
            {
                role: 'user',
                content: {
